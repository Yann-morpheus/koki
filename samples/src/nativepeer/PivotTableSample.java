...
import basics.EventListenersSample;
...
public class PivotTableSample
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        workbook.addWorkbookEventListener(new EventListenersSample.WorkbookEventListenerImpl());

        //Get the first (and the only) worksheet
        final Worksheet worksheet1 = workbook.getWorksheet(1);
        worksheet1.addWorksheetEventListener(new EventListenersSample.WorksheetEventListenerImpl());
        ...
        worksheet2.addWorksheetEventListener(new EventListenersSample.WorksheetEventListenerImpl());
        ...
        excelApp.getOleMessageLoop().doInvokeAndWait(new Runnable()
        {
            public void run()
            {
                ...
                Object obj = worksheetNativePeer.pivotTableWizard(new Variant(XlPivotTableSourceType.xlDatabase),  //SourceType
                ...
                PivotTable table = (PivotTable) obj;
