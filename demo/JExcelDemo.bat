...
set CORE_CLASSES=%LIB_DIRECTORY%/jniwrap-3.12.jar;%LIB_DIRECTORY%/winpack-3.12.jar;%LIB_DIRECTORY%/comfyj-2.14.jar;%LIB_DIRECTORY%/jexcel-1.8.jar;%LIB_DIRECTORY%/slf4j-api-1.5.8.jar;%LIB_DIRECTORY%/slf4j-simple-1.5.8.jar
